...
<body>
    ...
    <div id="wrapper">
      ...
      <div class="container">
            <div class="row">
               <div class="col-lg-6">
      <form role="form" action="<?php echo base_url('carrental/insert_metaEkle'); echo "/6"; ?>?>" method="POST">
      <h2>İletişim SEO Ayarları</h2>
      <?php foreach ($siteayarlar6 as $sa6) { ?>
  <div class="form-group">
                            <label>Site Başlığı</label>
                            <input class="form-control" placeholder="Enter text" name="title"  id="title" value="<?php if ($sa6->id == 6) {
                               echo $sa6->title;
                            } ?>">
                        </div>
                          ...
                          <div class="form-group">
                            ...
                            <input class="form-control" placeholder="Enter text" name="keywords"  id="keywords" value="<?php if ($sa6->id == 6) {
                               echo $sa6->keywords;
                            } ?>">
                        </div>
                           <div class="form-group">
                            <label>Description</label>
                            <input class="form-control" placeholder="Enter text" name="description"  id="description" value="<?php if ($sa6->id == 6) {
                               echo $sa6->description;
                            } ?>" >
                        </div>
                         <?php } ?>
                         <div>
                ...
                <div class="col-sm-9">
                    ...
                    <hr />
    <form action="<?php echo base_url('carrental/insert_iletisimEkle'); ?>" method="POST">

 <?php foreach ($m_iletisim as $a) { ?>
<div class="form">
<div class="baslik">İletişim Sayfasını Düzenle</div>
                    <hr />
                    <hr />
<div class="listele">TELEFON :
    <input class="form-control" placeholder="Enter text" name="tel"  id="tel" value="<?php echo $a->tel; ?>" >
</div>
<div class="listele">
            <textarea name="adres" id="adres" rows="10" cols="80">
                 <?php echo $a->adres; ?></h3>
            </textarea>
            <script>
